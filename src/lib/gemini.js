...
class GeminiRequestQueue {
  ...
  [];
  activeCount = 0;
  maxConcurrency = 1; // Queue execution sequentially to prevent parallel bursts
  delayBetweenRequestsMs = 1000; // Rate-limit protection delay

  async enqueue(fn, requestName) {
