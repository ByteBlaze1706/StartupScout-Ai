...
import {
  Plus, BarChart3, TrendingUp, ShieldCheck,
  Trash2, Copy, Eye, Layers, Download,
  History, Sparkles, RefreshCw, FileText, ChevronRight } from
'lucide-react';
import {
  AreaChart, Area, XAxis, YAxis, Tooltip, ResponsiveContainer,
  BarChart, Bar, PieChart, Pie, Cell, Legend } from
'recharts';
...
export default function DashboardPage() {
  ...
  projects.forEach((p) => {
    ...
    if (s >= 90) scoreBrackets['90+ Exceptional'] += 1;else
    if (s >= 80) scoreBrackets['80-89 Excellent'] += 1;else
    if (s >= 70) scoreBrackets['70-79 Validated'] += 1;else
    scoreBrackets['<70 Repivot'] += 1;
  });
