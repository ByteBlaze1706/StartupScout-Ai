...
import { 
  ...
  Settings, Check, Compass, TrendingUp, DollarSign, Award, 
  ChevronRight, Play, Presentation, Clock, HelpCircle, 
  Sparkles, CheckCircle2, AlertTriangle, ShieldCheck, Zap, Loader2
} from 'lucide-react';
import { 
...
export default function ProjectDetailsPage(props: Props) {
  ...
  // Tab control
  const [activeTab, setActiveTab] = useState<'score' | 'report' | 'mvp' | 'pitch' | 'team'>('score');
  ...
  const handleChatSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const finalHistory = [...updatedHistory, { role: 'assistant' as const, content: assistantMsg }];
